...
net.coupler.out <- function(graph_skel, dat, dat_compl, exp_dat, DE, survival_obj, always_set) {
  ...
  for (i in node_names) { # net.coupler.out loop over all metabolite nodes
    ...
    glmulti_obj <- glmulti(
      y = deparse(substitute(survival_obj)), # response variable to be predicted: SURV-object
...
net_coupler_out_iteration4 <- amb_met_loop_out$netout_sum$`4. iteration`

net_coupler_out_iteration5 <- amb_met_loop_out$netout_sum$`5. iteration`
...
net_coupler_out_direct1 <- amb_met_loop_out$netout_direct$`1. iteration`
net_coupler_out_direct2 <- amb_met_loop_out$netout_direct$`2. iteration`
net_coupler_out_direct3 <- amb_met_loop_out$netout_direct$`3. iteration`
net_coupler_out_direct4 <- amb_met_loop_out$netout_direct$`4. iteration`

net_coupler_out_direct_final <- rbind(net_coupler_out_direct1, net_coupler_out_direct2, net_coupler_out_direct3, net_coupler_out_direct4)

net_coupler_out_direct_final
# Outcome     avgHR     minHR     maxHR       upperP       lowerP Nbmds  NCov   Metabolite    ind_HR        ind_P          fdr     avgEst
# (chr)     (dbl)     (dbl)     (dbl)        (dbl)        (dbl) (dbl) (dbl)       (fctr)     (dbl)        (dbl)        (dbl)      (dbl)
# 1     NM2 0.8442885 0.8300534 0.8636166 1.037776e-02 3.472736e-03     4    53 rPC_ae_C30_1 0.8300534 3.472736e-03 1.168102e-02 -0.1692610
# 2    NM37 0.6812760 0.6491980 0.7287145 3.945706e-03 1.097966e-11    16    55 rPC_ae_C44_6 0.6893691 2.198359e-03 8.133930e-03 -0.3837878
# 3     NM9 0.5440311 0.4824541 0.6832704 1.826942e-08 5.943024e-13    32    56 rPC_ae_C34_3 0.4896470 1.614042e-12 5.971956e-11 -0.6087489
# 4    NM10 1.3291665 1.2181841 1.3976202 5.670649e-03 3.193277e-05    16    58 rPC_ae_C36_0 1.3508208 3.375653e-04 2.025392e-03  0.2845520
# 5    NM18 1.2805099 1.1869280 1.3663199 4.327927e-02 3.650267e-05    32    59 rPC_ae_C38_2 1.2789431 2.069988e-02 4.076866e-02  0.2472584
# 6    NM14 1.8232190 1.3059749 2.2750172 7.816947e-03 1.856944e-07    16    60 rPC_ae_C36_4 2.2365746 1.778747e-05 8.893736e-05  0.6006036
# 7    NM31 0.6978581 0.6305151 0.7710939 1.352378e-02 6.315765e-05    16    60 rPC_ae_C42_3 0.6640689 9.364736e-04 1.560789e-03 -0.3597395
...
net_coupler_out_direct_final <- rbind(net_coupler_out_direct1, net_coupler_out_direct2, net_coupler_out_direct3)
...
# Outcome     avgHR     minHR     maxHR       upperP       lowerP Nbmds  NCov      Metabolite    ind_HR        ind_P         fdr     avgEst     lowEst    highEst  bestGuess     DE  Assoc
# (chr)     (dbl)     (dbl)     (dbl)        (dbl)        (dbl) (dbl) (dbl)          (fctr)     (dbl)        (dbl)       (dbl)      (dbl)      (dbl)      (dbl)      (dbl) (fctr) (fctr)
# 1     NM1 1.2833655 1.2129413 1.3267770 0.0007217653 7.280893e-05     8    54 rlysoPC_a_C14_0 1.3267770 0.0002151221 0.001075611  0.2494859  0.1930482  0.2827527  0.2827527      1      1
# 2     NM4 0.8129152 0.7681928 0.8949337 0.0438151531 2.033511e-04     8    54 rlysoPC_a_C17_0 0.7791340 0.0014621175 0.002924235 -0.2071285 -0.2637145 -0.1110056 -0.2495722      2      2
# 3     NM7 0.7629834 0.6632055 0.8380781 0.0299660554 8.722133e-08    16    55 rlysoPC_a_C18_2 0.7499632 0.0006208699 0.001552175 -0.2705190 -0.4106705 -0.1766440 -0.2877311      2      2
# 4     NM6 0.7665707 0.6902069 0.8385771 0.0441451017 2.195726e-03     8    57 rlysoPC_a_C18_1 0.6950514 0.0058010906 0.011602181 -0.2658283 -0.3707639 -0.1760487 -0.3637694      2      2
...
net_coupler_out_direct_final
# Source: local data frame [4 x 18]

# Outcome     avgHR    minHR     maxHR      upperP       lowerP Nbmds  NCov Metabolite    ind_HR        ind_P          fdr     avgEst     lowEst    highEst  bestGuess     DE  Assoc
# (chr)     (dbl)    (dbl)     (dbl)       (dbl)        (dbl) (dbl) (dbl)     (fctr)     (dbl)        (dbl)        (dbl)      (dbl)      (dbl)      (dbl)      (dbl) (fctr) (fctr)
# 1    NM12 1.4803519 1.236366 1.7421290 0.009241804 1.056244e-10    64    57       rTyr 1.5130595 4.579158e-06 4.608763e-05  0.3922798  0.2121760  0.5551079  0.4141338      1      1
# 2     NM3 0.7520260 0.704213 0.8060214 0.000440262 1.304415e-07     8    54       rGly 0.7375299 6.583947e-06 4.608763e-05 -0.2849844 -0.3506744 -0.2156449 -0.3044486      2      2
...
#  Outcome    avgHR    minHR     maxHR      upperP       lowerP Nbmds  NCov Metabolite    ind_HR        ind_P          fdr     avgEst     lowEst    highEst  bestGuess     DE  Assoc
#   (chr)     (dbl)    (dbl)     (dbl)       (dbl)        (dbl) (dbl) (dbl)     (fctr)     (dbl)        (dbl)        (dbl)      (dbl)      (dbl)      (dbl)      (dbl) (fctr) (fctr)
# 1    NM10 0.8075392 0.7654121 0.8672132 0.01108100 3.611669e-04    16    55     rC18_2 0.7656500 8.594987e-04 0.004870492 -0.2137637 -0.2673409 -0.1424705 -0.2670301      2      2
# 2    NM12 1.1761571 1.1305091 1.2328019 0.03250638 2.623717e-03    32    56        rC3 1.1848463 2.109432e-02 0.071720672  0.1622524  0.1226681  0.2092896  0.1696130      1      1
# 3     NM4 0.7955879 0.7195483 0.8905948 0.04739194 1.090520e-05    32    56     rC14_1 0.7653019 7.609993e-04 0.004870492 -0.2286739 -0.3291317 -0.1158657 -0.2674849      2      2
# 4     NM6 1.3711644 1.1282390 1.5837807 0.04444566 7.958557e-07    16    55       rC16 1.5433539 3.428647e-06 0.000058287  0.3156603  0.1206580  0.4598149  0.4339579      1      1

# all final ambiguous effects:
amb_met_loop_out$netout_amb$`2. iteration`
# Source: local data frame [1 x 18]

...
So for instance, you want to ask questions to get answers that looks like:

![Answers to specific types of questions that NetCoupler can help with.](vignettes/aim-output.png)
...
![NetCoupler functions and their input and ouput. Input and output objects are the light gray boxes, while the light blue boxes are the currently available functions, and the light orange boxes are functions planned to be developed.](nc-diagram-io.png)

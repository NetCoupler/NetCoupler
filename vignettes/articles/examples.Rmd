...
![General form for questions that NetCoupler aims to help answer.](vignettes/aim-question.png)

If we want to estimate the links on the left hand side (the exposure side),
where to 

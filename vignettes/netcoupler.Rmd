...
metabolite network, NetCoupler uses an implementation of the PC-algorithm {{cite
177, 145, 148, 178}}. Because of this, the assumptions from the PC-algorithm
apply to NetCoupler. The output of this algorithm is a graphical model (`G`) of
the underlying network that is used by NetCoupler.

...
metabolite_network <- nc_create_network(renamed_simulated_data, .05)
...
extracted_estimates <- getExp.coef.out(object = net_coupler_case, metabolite = simulated_data %>% 
...
Metabolites should be standardized (residuals from lm) on the exposure...?
